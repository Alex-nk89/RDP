...
function ModalsProvider({ children, modalProps, labels, modals }) {
  ...
  const content = (currentModal == null ? void 0 : currentModal.type) === "context" ? /* @__PURE__ */ React__default.createElement(ContextModal, {
    context: ctx,
    id: currentModal == null ? void 0 : currentModal.id
  }) : (currentModal == null ? void 0 : currentModal.type) === "confirm" ? /* @__PURE__ */ React__default.createElement(ConfirmModal.ConfirmModal, __spreadProps(__spreadValues({}, currentModal.props), {
    id: currentModal.id,
