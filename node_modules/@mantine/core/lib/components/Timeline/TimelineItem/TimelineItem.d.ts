...
export declare function TimelineItem({ className, bullet, title, bulletSize, lineWidth, active, lineActive, classNames, styles, children, color, align, lineVariant, ...others }: TimelineItemProps): JSX.Element;
