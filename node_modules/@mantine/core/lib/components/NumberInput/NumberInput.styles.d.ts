...
declare const _default: (params: NumberInputStyles, options?: import("../mantine-styles/src/tss/create-styles").UseStylesOptions<"rightSection" | "control" | "controlUp" | "controlDown">) => {
