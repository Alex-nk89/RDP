...
declare const _default: (params: BadgeStyles, options?: import("../mantine-styles/src/tss/create-styles").UseStylesOptions<"outline" | "light" | "dot" | "filled" | "rightSection" | "gradient" | "root" | "inner" | "leftSection">) => {
