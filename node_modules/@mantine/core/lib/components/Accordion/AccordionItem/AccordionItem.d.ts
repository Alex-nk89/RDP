...
export declare function AccordionItem({ opened, onToggle, label, children, className, classNames, styles, transitionDuration, icon, disableIconRotation, offsetIcon, iconSize, iconPosition, id, controlRef, onControlKeyDown, ...others }: AccordionItemProps): JSX.Element;
