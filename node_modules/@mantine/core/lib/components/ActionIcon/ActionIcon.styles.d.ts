...
declare const _default: (params: ActionIconStyles, options?: import("../mantine-styles/src/tss/create-styles").UseStylesOptions<"outline" | "transparent" | "light" | "default" | "filled" | "loading" | "root" | "hover">) => {
