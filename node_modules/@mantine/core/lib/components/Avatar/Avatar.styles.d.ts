...
declare const _default: (params: AvatarStyles, options?: import("../mantine-styles/src/tss/create-styles").UseStylesOptions<"image" | "placeholder" | "root" | "placeholderIcon">) => {
