...
declare const _default: (params: StepperStyles, options?: import("../mantine-styles/src/tss/create-styles").UseStylesOptions<"content" | "separator" | "root" | "steps" | "separatorActive">) => {
