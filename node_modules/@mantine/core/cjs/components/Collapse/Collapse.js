...
function Collapse(_a) {
  ...
  return /* @__PURE__ */ React__default.createElement(Box.Box, __spreadValues({}, getCollapseProps(__spreadValues({ style: mergedStyles }, rest))), /* @__PURE__ */ React__default.createElement("div", {
    style: {
      opacity: opened ? 1 : 0,
