...
const Tabs = forwardRef((_a, ref) => {
  ...
  const { classes, cx } = useStyles({ tabPadding, orientation }, { classNames, styles, name: "Tabs" });
  const controlRefs = useRef({});
  const tabs = React.Children.toArray(children).filter((item) => item.type === TabControl);
