...
export declare function MonthsList({ amountOfMonths, month, locale, minDate, maxDate, allowLevelChange, size, daysRefs, onMonthChange, onNextLevel, onDayKeyDown, classNames, styles, __staticSelector, nextMonthLabel, previousMonthLabel, labelFormat, ...others }: MonthsListProps): JSX.Element;
