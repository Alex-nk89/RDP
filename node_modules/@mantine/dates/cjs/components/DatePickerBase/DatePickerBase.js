...
const DatePickerBase = React.forwardRef((_a, ref) => {
  ...
  hooks.useClickOutside(() => dropdownType === "popover" && !allowFreeInput && closeDropdown(), null, [
    dropdownElement,
    rootElement
  ]);
  ...
  return /* @__PURE__ */ React__default.createElement(core.InputWrapper, __spreadValues(__spreadValues({
    ...
    styles,
    onClick: () => !allowFreeInput ? setDropdownOpened(!dropdownOpened) : setDropdownOpened(true),
