...
const DateRangePicker = forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(DatePickerBase, __spreadValues({
    ...
    styles,
    classNames,
    inputLabel: valueValid ? `${upperFirst(dayjs(_value[0]).locale(finalLocale).format(dateFormat))} ${labelSeparator} ${upperFirst(dayjs(_value[1]).locale(finalLocale).format(dateFormat))}` : "",
